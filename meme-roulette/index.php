...
<html lang="en">
  <head>
    <title>Meme Roulette | Roulette Deck</title>
    <meta charset="utf-8">
  ...
  <?php 
            // Image extensions
            $image_extensions = array("PNG","png","JPG","jpg","JPEG","jpeg","GIF","gif");
                    ...
                    while (($file = readdir($dh)) !== false){
                        ...
                        if($file != '' && $file != '.' && $file != '..'){
                            ...
                            if(!is_dir($image_path) && 
                                ...
                                <!-- Image -->
                                <a href="<?php echo $image_path; ?>" class="d-block photo-item" data-fancybox="gallery">
                                    <img src="<?php echo $thumbnail_path; ?>" title="" alt="Image" class="img-fluid"/>
                                </a>
                                <!-- --- -->
                                <?php
...
>>>>>>> 1d71d069d9d712aa813d0985d3b72b05b19af04c
</html>